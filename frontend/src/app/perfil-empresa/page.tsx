                ...
                <CardHeader>
                  <div className="flex items-center space-x-4">
                    <Avatar className="w-20 h-20">
                      <AvatarImage src="/placeholder.svg?height=80&width=80" alt={businessProfile.name} />
                      <AvatarFallback>{businessProfile.name.split(' ').map((n: string) => n[0]).join('')}</AvatarFallback>
                    </Avatar>
                    <div>
                      <CardTitle className="text-2xl font-bold">{businessProfile.name}</CardTitle>
                      <Badge>{businessProfile.address}</Badge>
                    </div>
                  </div>
                </CardHeader>
